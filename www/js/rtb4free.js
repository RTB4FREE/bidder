            ...
            for (var j = 0; j < lines.length; j++) {
            	var line = lines[j];
  			    ...
  			    if (typeof y.sev !== 'undefined') {
                    ...
                    var show = true
  		    	    if (instance != "") {
  		    	        if (y.instance.indexOf(instance) > -1)
  		    	            show = true
  		    	        else
  		    	            show = false
  		    	    }
                    ...
                    if (show)
  				         $('#logger tr:last').after('<tr><td style="width:10%">' + datestring + '</td>' +
  				            '<td style="width:10%;text-align:left;">' + y.instance + '</td>' +
  						    '<td style="width:5%;text-align:left;">' + y.sev + '</td>' +
  						    '<td style="width:5%;text-align:left;">' + y.source + '</td>' +
...
Logger.prototype.setInstanceFilter = function(f) {
    instance = f
}
